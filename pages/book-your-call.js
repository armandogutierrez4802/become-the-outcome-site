...
export default function BookYourCall() {
    ...
    // (async () => {
    //     const data = await fetch("https://calendly.com/becometheoutcome/30min");
    //     console.log(data);
    //     setLoading(false);
    // })
    // }, []);
    ...
    const spinner = (
        <div className="text-center py-18 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <div role="status">
